...
insert into Shopper VALUES (1, 1, "A","A@"), (2, 2, "B", "B@"),
                        (3, 3, "C", "C@"),(4, 4, "D", "D@");

insert into ShopperAddress VALUES (1, "Address1"), (2, "Address2"),
                                  (3, "Address3"),(4, "Address4");

insert into Category VALUES (1 , "Mobiles",NULL), (2 , "Clothing", NULL),
                            (3 , "Grocery",NULL), (4, "Utensils",NULL),
                            (5 , "Electronics",NULL), (6 , "Laptops",NULL),
                            (11 , "Kids", 2), (21, "Men", 2),
                            (31, "Women", 2), (51, "Utility", 6),
                            (61, "Gaming", 6), (71, "Business", 6),
                            (81, "AC", 5), (9, "Refrigerator", 5);

insert into Product Values (1, "Shirt", 1000, 50,CAST(N'2012-06-18 10:34:09.000' AS DateTime), "Shirt","Active"),
                           (2, "Pants", 1000, 50,CAST(N'2012-07-18 10:34:09.000' AS DateTime), "Shirt","Active"),
                           (3, "Nokia", 1000, 30,CAST(N'2012-06-18 10:35:09.000' AS DateTime), "Mobile","Active"),
                           (4, "Samsung", 1000, 50,CAST(N'2012-06-19 10:34:09.000' AS DateTime), "Mobile","Active"),
                           (5, "Stove", 1000, 50,CAST(N'2012-03-19 10:34:09.000' AS DateTime), "Utensil","Active"),
                           (6, "Dell", 1000, 50,CAST(N'2012-06-19 10:34:09.000' AS DateTime), "Laptop utility","Active"),
                           (7, "Acer", 1000, 50,CAST(N'2012-06-19 11:34:09.000' AS DateTime), "Laptop gaming","Active"),
                           (8, "Cooking oil", 1000, 50,CAST(N'2012-06-19 09:34:09.000' AS DateTime), "Grocery","Active"),
                           (9, "Samsung AC", 1000, 50,CAST(N'2012-06-19 12:34:09.000' AS DateTime), "AC","Active"),
                           (10, "LG", 1000, 41,CAST(N'2012-06-19 10:34:09.000' AS DateTime), "refrigerator","Active");
