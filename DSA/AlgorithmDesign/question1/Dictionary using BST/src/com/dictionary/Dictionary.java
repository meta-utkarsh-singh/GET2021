...
public interface Dictionary {
	 ...
	 */
	void add(String key, String value, Node root);
	/**
	 * 
	 ...
	 */
	String getValue(String key, Node root);
	/**
	 * 
	 * @return list of key value pair in sorted order
	 */
	void getSorted(Node root, List<Node> listOfKeyValue);
	/**
	 * 
	 ...
	 */
	void getSortedBetween(String k1, String k2, Node root, List<Node> sortedList);
}
